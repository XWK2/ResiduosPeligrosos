<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatUsuarios.aspx.cs" Inherits="ResiduosPeligrosos.CatUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Usuarios \ Filters ">
                    <ContentTemplate>
                            ...
                            <table style="float: left; width: 40%; margin-left:5px" class="OptionsTable BottomMargin">
                                ...
                                <tr>
                                    <td style="width:10%; text-align:left">
                                        <dx:ASPxLabel ID="lblPosicion" runat="server" Text="Posición "></dx:ASPxLabel>
                                    </td>
                                ...
                                <tr>
                                    <td style="width:10%; text-align:left">
                                        <dx:ASPxLabel ID="lblProveedor" runat="server" Text="Proveedor "></dx:ASPxLabel>
                                    </td>
                                    <td style="width:30%; text-align:left">
                                ...
                                <tr>
                                    <td style="width:10%; text-align:left">
                                        <dx:ASPxLabel ID="lblUsuario" runat="server" Text="Usario "></dx:ASPxLabel>
                                    </td>
                                    <td style="width:30%; text-align:left">
    ...
    <div id="Detalle" runat="server">  
        <dx:ASPxGridView ID="xgrdUser" runat="server" ClientInstanceName="grid" AutoGenerateColumns="true"  Width="100%" Font-Names="Segoe UI" Theme="Metropolis" KeyFieldName="UsuarioId"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Username" VisibleIndex="3" Caption="Usuario" Width="10%"/>                         
                <dx:GridViewDataTextColumn FieldName="CodigoPerfil" VisibleIndex="4" Caption="Código Perfil" Width="5%" Visible="false"/>  
                <dx:GridViewDataTextColumn FieldName="Perfil" VisibleIndex="5" Caption="Perfil" Width="10%"/>                                            
                <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="6" Caption="Empleado" Width="5%"/>  
                <dx:GridViewDataTextColumn FieldName="NombreCompleto" VisibleIndex="7" Caption="Nombre" Width="30%"/>
                <dx:GridViewDataTextColumn FieldName="Email" VisibleIndex="8" Caption="Email" Width="20%"/>        
                <dx:GridViewDataTextColumn FieldName="CodigoPosicion" VisibleIndex="9" Caption="Código de Posición" Width="5%"/>  
                <dx:GridViewDataTextColumn FieldName="Posicion" VisibleIndex="10" Caption="Posición" Width="10%"/>
            </Columns>
                ...
                <EditForm>
                  <div class="container col-xs-12" style="background-color:#F2F2F2;padding:0px;margin:0px;">
                    <div class="form-group" style="width:100%;padding:0px;margin:0px;">
                        ...
                        <h4 class="modal-title" style="text-align:right;margin-top:10px;margin-bottom:10px;margin-right:5px;">Registro de Usuarios</h4>
                        ...
                        <div class="col-xs-12">
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblUserName" Text="Usuario" Font-Names="Segoe UI"></dx:ASPxLabel>
                                <div class="col-md-9">
                            ...
                            <div class="row" id="divPassword" runat="server">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblPassword" Text="Contraseña" Font-Names="Segoe UI"></dx:ASPxLabel>
                                <div class="col-md-9">
                            ...
                            <div class="row" id="divConfirm" runat="server">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblConfirm" Text="Confirmar" Font-Names="Segoe UI"></dx:ASPxLabel>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblEmpleado" Text="Empleado" Font-Names="Segoe UI"></dx:ASPxLabel>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="ASPxLabel2" Text="Perfil" Font-Names="Segoe UI"></dx:ASPxLabel>
                                <div class="col-md-9">
