<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatParametros.aspx.cs" Inherits="ResiduosPeligrosos.CatParametros" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar1" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False" CssClass="nav-smartit">
            <Groups>
                <dx:NavBarGroup Text="Parámetros\ Filtros">
                        <ContentTemplate>
                                <div id="Parametros" runat="server" visible="true">
                                    <div class="row" style="padding-top:5px">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <dx:ASPxLabel ID="lblDescripcionBusqueda" runat="server" Text="Descripción " CssClass="text-nav"></dx:ASPxLabel>
                                        </div>
                                    ...
                                    <div class="row" style="padding-top:5px">
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                            <dx:ASPxLabel ID="ASPxLabel1" runat="server" Text="Registros Activos " CssClass="text-nav"></dx:ASPxLabel>
    ...
    <div id="Detalle" runat="server">
        <dx:ASPxGridView ID="xgrdParametro" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="Valor" VisibleIndex="2" Caption="Valor" Width="50%">
                            <Settings AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Padre" VisibleIndex="3" Caption="Padre" Width="30%">
                            <Settings AutoFilterCondition="Contains" />
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Encriptado" VisibleIndex="4" Caption="Encriptado" Width="5%"></dx:GridViewDataTextColumn>
                            ...
                            <div style="margin:1px 1px 1px 1px; background-color:#F2F2F2" >
                                   ...
                                   <tr style="background-color:grey; vertical-align:middle">
                                        <td style="height:22px; text-align:left">
                                            <img src="<%= ResolveClientUrl("~/Assets/Images/save.png")%>" alt="Guardar" style="cursor:pointer" onclick="return raiseValidation();" />
                                        </td>
                                        <td style="height:22px; text-align:right">
                                            <img src="<%= ResolveClientUrl("~/Assets/Images/Close.png")%>" alt="Salir" style="cursor:pointer" onclick="return grid.CancelEdit();" />
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td colspan="2" style="height:40px; padding-right:10px; text-align:right">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Parámetros" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="lblDescripcion" Text="Nombre" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td >
                                                        <dx:ASPxLabel runat="server" ID="lblEncrypted" Text="Encriptado" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxCheckBox ID="chkEncrypted" runat="server" CssClass="labelGral" Width="100%" Font-Bold="true" ForeColor="White" Text=""  
                                                            Checked='<%# ValidaBoleano(Eval("Encriptado")) %>' Enabled="true">
                                                        </dx:ASPxCheckBox>
                                                    </td>
                                                </tr>
                                                <tr style="height:10px"></tr>
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="lblValue" Text="Valor" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
