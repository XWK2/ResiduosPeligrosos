...
namespace ResiduosPeligrosos
{
    public partial class CatPlanta : BasePage
    {
        ...
        protected void xgrdPlanta_RowUpdating(object sender, DevExpress.Web.Data.ASPxDataUpdatingEventArgs e)
        {
            ...
            var Direccion2 = ((ASPxTextBox)xgrdPlanta.FindEditFormTemplateControl("xtxtDireccion2Edit")).Text;
            var rfc = ((ASPxTextBox)xgrdPlanta.FindEditFormTemplateControl("xtxtRFCEdit")).Text;

            try
            {
                var BPlanta = new PlantaDa();
                var res = BPlanta.UpdPlanta(LoginInfo.CurrentUsuario.UsuarioId, DeptoId, Codigo, Descripcion, Direccion, Direccion2, rfc);
                if (res == 1)
        ...
        protected void xgrdPlanta_RowInserting(object sender, DevExpress.Web.Data.ASPxDataInsertingEventArgs e)
        {
            ...
            {
                var BPlanta = new PlantaDa();
                var res = BPlanta.InsPlanta(LoginInfo.CurrentUsuario.UsuarioId, Codigo, Descripcion, Direccion, Direccion2, rfc);
                if (res == 1)
