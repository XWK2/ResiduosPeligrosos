<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatPassword.aspx.cs" Inherits="ResiduosPeligrosos.CatPassword" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Cambio de Contraseña">
                    <ContentTemplate>
                                ...
                                <table style="float: left; width: 40%" class="OptionsTable BottomMargin">
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel runat="server" ID="lblCurrentPW" Text="Contraseña Anterior" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <dx:ASPxLabel runat="server" ID="lblNewPW" Text="Nueva Contraseña" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td> 
                                            <dx:ASPxLabel runat="server" ID="lblConfirm" Text="Confirmar" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div class="div-container">
                                                                            <div class="div-img" > 
                                                                                <img class="img" src="Assets/Images/Save.png" alt="Guardar" style="cursor:pointer" onclick="return ChangePassword();" title="Save"/>
                                                                            </div>
                                                                        </div>
                                                                    </td>  
                                                                    <td>
                                                                        <div class="div-container">
                                                                            <div class="div-img" style="padding-left:15px" > 
                                                                                <img class="img" src="Assets/Images/Close.png" alt="Salir" style="cursor:pointer" onclick="return CloseView();" title="Close" />
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    <td>
