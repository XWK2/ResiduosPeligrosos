<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatMonedas.aspx.cs" Inherits="ResiduosPeligrosos.CatMonedas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        ...
        <Groups>
            <dx:NavBarGroup Text="Moneda \ Filtros">
                    <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
        <dx:ASPxGridView ID="xgrdMoneda" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="MonedaID" 
            ...
            <Columns>
                <dx:GridViewDataTextColumn FieldName="MonedaID" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                ...
                <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Nombre" Width="55%"></dx:GridViewDataTextColumn>
                <dx:GridViewDataTextColumn FieldName="Simbolo" VisibleIndex="4" Caption="Símbolo" Width="20%"></dx:GridViewDataTextColumn>
            </Columns>
                                    ...
                                    <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                        <tr style="height:40px">
                                            <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Registro de Monedas" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <tr>
                                <td style="vertical-align:top">
                                    <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">                                               
                                        ...
                                        <tr>
                                            <td style="padding-left: 10px">
                                                <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Símbolo" Font-Names="Segoe UI"></dx:ASPxLabel>
                                            </td>
                                            <td>
                                ...
                                <td style="vertical-align:top">
                                    <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                        ...
                                        <tr>
                                            <td style="padding-left: 10px">
                                                <dx:ASPxLabel runat="server" ID="ASPxlblPresicion" Text="Precisión" Font-Names="Segoe UI"></dx:ASPxLabel>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="padding-left: 10px">
                                                <dx:ASPxLabel runat="server" ID="ASPxlblSepMillar" Text="Separador de Miles" Font-Names="Segoe UI"></dx:ASPxLabel>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td style="padding-left: 10px">
                                                <dx:ASPxLabel runat="server" ID="ASPxLabel4" Text="Separador de Decimales" Font-Names="Segoe UI"></dx:ASPxLabel>
                                            </td>
                                            <td>
