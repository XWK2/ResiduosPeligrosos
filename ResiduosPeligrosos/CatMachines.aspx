<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatMachines.aspx.cs" Inherits="ResiduosPeligrosos.CatMachines" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Machines \ Filtros">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdMaquina" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="MaquinaID" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Nombre" Width="60%">
                        </dx:GridViewDataTextColumn>                   
                    </Columns>
