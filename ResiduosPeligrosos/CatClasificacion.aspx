<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatClasificacion.aspx.cs" Inherits="ResiduosPeligrosos.CatClasificacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Clasificaciones \ Filtros">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdClasificacion" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="clasificacionId" 
                    oncustomcallback="xgrdClasificacion_CustomCallback" ClientInstanceName="grid"                   
                    onrowvalidating="xgrdClasificacion_RowValidating" onrowinserting="xgrdClasificacion_RowInserting" onrowupdating="xgrdClasificacion_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdClasificacion_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="clasificacionId" Visible="false" Caption="id" VisibleIndex="0"></dx:GridViewDataTextColumn>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Registro de Clasificaciones" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
