<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatMenu.aspx.cs" Inherits="ResiduosPeligrosos.CatMenu" %>
                                         ...
                                         <div id="Parametros" runat="server" visible="true">
                                            <table style="float: left; width: 40%" class="OptionsTable BottomMargin">
                                               <tr>
                                                ...
                                                <tr>
                                                     <td style="width:10%; text-align:left">
                                                        <dx:ASPxLabel ID="lblApps" runat="server" Text="Applicación "></dx:ASPxLabel>
                                                     </td>
                                                     <td style="width:30%; text-align:left">
                                                                            ...
                                                                            <tr>
                                                                                  <td style="width:20%">
                                                                                     <div class="div-container">
                                                                                      <div class="div-img" >
                                                                                        <img class="img" src="Assets/Images/trash_can.png" alt="Eliminiar Seleccionados" style="cursor:pointer" onclick="return DisableSelected();" title="Eliminiar Seleccionados" />
                                                                                      </div>
                                                                                     </div>
                                                                                </td>
                                                                                <td style="width:20%" >
                                                                                    <div class="div-container">
                                                                                      <div class="div-img" >
                                                                                         <img class="img" src="Assets/Images/delete_all.png" alt="Eliminiar Todos" style="cursor:pointer" onclick="return DisableAll();" title="Eliminiar Todos" /> 
                                                                                      </div>
                                                                                    </div>
                                                                                </td>
                                                                                 <td>
...
<div id="Detalle" runat="server"> 
    <dx:ASPxGridView ID="xgrdSA" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="0" Width="10px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="PerfilId"  Caption="PerfilId" Width="10%" VisibleIndex="1" Visible="false"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" Caption="Código" VisibleIndex="2"  Width="10%" Visible="true"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="MenuPadre"  Caption="Menu Padre" VisibleIndex="3" Width="10%" Visible="true"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="MenuId"  Caption="Código del Menú" VisibleIndex="4" Width="10%" Visible="true"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Nombre" Caption="Nombre"  VisibleIndex="5" Width="35%"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="URL" Caption="URL" VisibleIndex="6"  Width="35%"></dx:GridViewDataTextColumn>
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Accesos a Manúes" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>                                               
                                                <tr>
                                                ...
                                                <tr>
                                                    <td colspan="2" style="background-color:#E0E0E0; height:20px; padding-left: 10px;" >
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Perfil " Font-Size="12pt" Font-Names="Segoe UI" Font-Bold="true"></dx:ASPxLabel>                                                                                                    
                                                        <dx:ASPxLabel runat="server" ID="lblCodigo" Text='<%# Eval("Codigo")%>' Font-Size="12pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>        
                                                 <tr>
                                                    <td colspan="2" style="background-color:#E0E0E0; height:20px; padding-left: 10px;" >                                                              
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel2" Text="Menú " Font-Size="12pt" Font-Names="Segoe UI" Font-Bold="true"></dx:ASPxLabel>
                                               ...
                                               <tr style="height:10px"></tr>                               
                                                 <tr>
                                                    <td colspan="2" style="height:20px; padding-left: 10px;">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel4" Text="Opciones" Font-Size="12pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                               <tr style="height:10px"></tr>
                                                <tr>                                                   
