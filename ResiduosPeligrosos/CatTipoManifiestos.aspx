<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatTipoManifiestos.aspx.cs" Inherits="ResiduosPeligrosos.CatTipoManifiestos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Tipos de Manifiestos  \ Filtros">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdTipoManifiesto" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="TipoManifiestoId" 
                    oncustomcallback="xgrdTipoManifiesto_CustomCallback" ClientInstanceName="grid" 
                    onrowvalidating="xgrdTipoManifiesto_RowValidating" onrowinserting="xgrdTipoManifiesto_RowInserting" onrowupdating="xgrdTipoManifiesto_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdTipoManifiesto_HtmlDataCellPrepared" OnHtmlEditFormCreated="xgrdTipoManifiesto_HtmlEditFormCreated" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="TipoManifiestoId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1" Width="10px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Código" Width="10%"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Nombre" Width="35%"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="CodigoTipoMaterial" VisibleIndex="4" Caption="Código del Tipo" Width="10%"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="TipoMaterial" VisibleIndex="5" Caption="Tipo" Width="35%"></dx:GridViewDataTextColumn>
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Resgitro de Tipo de Manifiestos" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:50%;">
                                                        <table style="width:100%; padding-left:0px; padding-right:0px; padding-bottom:0px; padding-top:0px">
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 10px">
                                                                    <dx:ASPxLabel runat="server" ID="ASPxTipoMaterial" Text="Tipo de Material" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td style="padding-left: 10px;">
                                                                    <input type="hidden" id="hdnCodigoTipoMaterial" value='<%# Eval("CodigoTipoMaterial")%>' runat="server"/>
                                                                    <dx:ASPxComboBox CssClass="form-control" ID="cmbTipoMaterialEdit" runat="server" FocusedStyle-Border-BorderColor="#3399ff" Width="200px"
                                                                    Font-Names="Segoe UI" IncrementalFilteringMode="Contains" FilterMinLength="0" EnableCallbackMode="True" OnDataBound="cmbTipoMaterialEdit_DataBound" CallbackPageSize="20" Theme="SoftOrange"
