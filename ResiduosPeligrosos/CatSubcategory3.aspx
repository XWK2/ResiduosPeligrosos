<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatSubcategory3.aspx.cs" Inherits="ResiduosPeligrosos.CatSubcategory3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="SubCategorys 3 \ Filtros">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdSubcategoria3" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="Subcategoria3ID" 
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Nombre" Width="20%">
                        </dx:GridViewDataTextColumn>
