<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatPhoto.aspx.cs" Inherits="ResiduosPeligrosos.CatPhoto" %>
...
<div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Cambio de Foto">
                                    <ContentTemplate>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align:center; width:25%">
                                                                        <dx:ASPxButton ID="btnUploadGraphicsFile" runat="server" AutoPostBack="False" 
                                                                            Text="Subir" ClientInstanceName="btnUploadGraphicsFile"
                                                                ...
                                                                <tr>
                                                                    <td class="note">
                                                                        <dx:ASPxLabel ID="lblAllowebMimeTypeGraphicsFile" runat="server" 
                                                                            Text="Tipo de immágenes permitidas: JPG, GIF, BMP, PNG" CssClass="labelGral"
                                                                            Font-Size="8pt">
                                                                        </dx:ASPxLabel>
                                                                        <br />
                                                                        <dx:ASPxLabel ID="lblMaxFileSizeGraphicsFile" runat="server" 
                                                                            Text="Tamaño máximo del archivo: 4Mb" Font-Size="8pt" CssClass="labelGral">
                                                                        </dx:ASPxLabel>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    <div class="div-container">
                                                                                      <div class="div-img" > 
                                                                                         <img class="img" src="Assets/Images/Close.png" alt="Salir" title="Close" style="cursor:pointer" onclick="return CloseView();" />
                                                                                      </div>
                                                                                    </div>
                                                                                </td>  
                                                                                <td>                                                                                   
                                                                                    <dx:ASPxCallback runat="server" ID="cbSaveVars" ClientInstanceName="cbSaveVars" oncallback="cbRecovery_Callback"></dx:ASPxCallback>
                                                                                </td>                   
                                                                            </tr>
                                                                        </table>
                                                                    </div>
