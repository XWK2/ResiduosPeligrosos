...
namespace ResiduosPeligrosos.dataAccess
{
    public class MttoAlmnDa: Base
    {
        ...
        public int UpdMttoAlmn(int IdUser, int MttoAlmnID, string Codigo, string especificacion, string notas, string clasificacion, string responsable, string tipo)
        {
            ...
            Entity.UpdResiduosResult_ regreso = JsonConvert.DeserializeObject<Entity.UpdResiduosResult_>(methodPost("UpdMttoAlmn/" + IdUser.ToString(), JsonConvert.SerializeObject(util)));
