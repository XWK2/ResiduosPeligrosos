<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatPerfiles.aspx.cs" Inherits="ResiduosPeligrosos.CatPerfiles" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">    
    ...
    <dx:ASPxNavBar ID="ASPxNavBar1" runat="server" Width="100%" Font-Bold="false" Theme="Metropolis" >
        <Groups>
            <dx:NavBarGroup Text="Perfiles \ Filtros">
                <ContentTemplate>
                    <div id="parametros" runat="server" visible="true">
                        <table style="float: left; width: 40%; margin-left:5px" class="OptionsTable BottomMargin">
                            ...
                            <tr>
                                <td style="width:10%; text-align:left">
                                    <dx:ASPxCheckBox ID="chkActive" runat="server" Theme="SoftOrange" ClientInstanceName="chkActive" Text="Registros Activos" Checked="true" TextAlign="Left"></dx:ASPxCheckBox>
                                </td>
                                <td style="width:20%; text-align:right">                                                         
                                    <dx:ASPxButton ID="btnBuscar" runat="server" Text="Buscar" Theme="SoftOrange" ClientInstanceName="btnBuscar" AutoPostBack="false">
                                                    ...
                                                    <table>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <dx:ASPxCallbackPanel ID="CallbackPanelDowload" ClientInstanceName="CallbackPanelDowload" runat="server" Width="200px" oncallback="CallbackPanelDowload_Callback"></dx:ASPxCallbackPanel>                                                                                     
                                                            </td>
                                                        </tr>                                                                            
                                                    </table>
                                                </div>
...
<div id="Detalle" runat="server">        
      <dx:ASPxGridView ID="xgrdPerfiles" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False" 
        ...
        <Columns>                                            
            <dx:GridViewDataTextColumn FieldName="PerfilId" Visible="false" Caption="Identifier"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="0" Width="10%"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="1" Caption="Código" Width="20%"></dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="2" Caption="Descripción" Width="55%"></dx:GridViewDataTextColumn>
            <dx:GridViewDataCheckColumn FieldName="EsAdministrador" VisibleIndex="3" Caption="Es Adminsitrador" Width="10%"></dx:GridViewDataCheckColumn>
            <dx:GridViewDataCheckColumn FieldName="RealizaEncuestas" VisibleIndex="3" Caption="Cuotas de Aprobación" Width="10%"></dx:GridViewDataCheckColumn>
        </Columns>
                                ...
                                <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                    <tr style="height:40px">
                                        <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                            <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Registro de Perfiles" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px">
                                            <dx:ASPxLabel runat="server" ID="lblFolio" Text="Folio" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px">
                                            <dx:ASPxLabel runat="server" ID="lblKey" Text="Código" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px">
                                            <dx:ASPxLabel runat="server" ID="lblDescription" Text="Descripción" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px">
                                            <dx:ASPxLabel runat="server" ID="lblEsAdministrador" Text="Es Admnistrador" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="padding-left: 10px">
                                            <dx:ASPxLabel runat="server" ID="lblRealizaEncuestas" Text="Cuotas de Aprobación" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                          <td style="padding-left: 10px">
                                            <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Aplicación" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                        <td>           
                                              <table>
                                               <tr>
                                                   ...
                                                   <td style="padding-left: 20px">
                                                       <dx:ASPxLabel runat="server" ID="ASPxLabel4" Text=" + Opciones" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                   </td>
                                                    <td style="padding-left: 10px;vertical-align:central">
                                                        <div class="div-container">
                                                            <div class="div-img" >
                                                            <img class="img" src="Assets/Images/New.png" alt="Agregar" title="Agregar" style="cursor:pointer" onclick="return xgrdApps.PerformCallback('Save');"/>                                                
                                                            </div>
                                                        </div>                                           
                                                    </td> 
                                                    <td style="vertical-align:central">
                                                         <div class="div-container">
                                                            <div class="div-img" >
                                                            <img class="img" src="Assets/Images/trash_can.png" alt="Eliminar Todos" style="cursor:pointer" onclick="return xgrdApps.PerformCallback('Delete');" title="Eliminar Todos" />
                                                            </div>
                                                        </div>
                                                    </td>
                                               </tr>
                                    ...
                                    <tr style="vertical-align:top" id="trAccess">                                                    
                                        <td style="padding-left: 10px; padding-right:10px" colspan="2">
                                            <dx:ASPxGridView ID="xgrdApps" runat="server" AutoGenerateColumns="true" 
                                                ...
                                                <Columns>
                                                    <dx:GridViewDataTextColumn FieldName="AppId" Caption="Folio" VisibleIndex="0" Width="30%"></dx:GridViewDataTextColumn>
                                                    <dx:GridViewDataTextColumn FieldName="Nombre" Caption="Aplicación" VisibleIndex="1" Width="70%"></dx:GridViewDataTextColumn>
                                                </Columns>
                                                <Styles>
                                                    <AlternatingRow BackColor="#F2F2F2"></AlternatingRow>
                                                    <RowHotTrack BackColor="#CEECF5"></RowHotTrack>
