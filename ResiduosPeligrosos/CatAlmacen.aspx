<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatAlmacen.aspx.cs" Inherits="ResiduosPeligrosos.CatAlmacen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Almacén \ Filtros">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdwarehouse" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="almacenId" 
                    oncustomcallback="xgrdwarehouse_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdwarehouse_RowDeleting"                     
                    onrowvalidating="xgrdwarehouse_RowValidating" onrowinserting="xgrdwarehouse_RowInserting" onrowupdating="xgrdwarehouse_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdwarehouse_HtmlDataCellPrepared" OnHtmlEditFormCreated="xgrdwarehouse_HtmlEditFormCreated" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="almacenId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn FieldName="nombreAlmacen" VisibleIndex="3" Caption="Desripción"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="codigoPlanta" VisibleIndex="4" Caption="Código Planta"></dx:GridViewDataTextColumn>    
                         <dx:GridViewDataTextColumn FieldName="planta" VisibleIndex="5" Caption="Planta"></dx:GridViewDataTextColumn>                                                                    
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Registro de Almacén" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width:50%;">
                                                        <table style="width:100%; padding-left:0px; padding-right:0px; padding-bottom:0px; padding-top:0px">
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxLabel runat="server" ID="lblalmacen" Text="Descripción" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td>
                                                                    <dx:ASPxTextBox runat="server" ID="xtxtNombreAlmacenEdit" theme="SoftOrange" Width="100%" Text='<%# Eval("nombreAlmacen")%>' Font-Names="Segoe UI"
                                                                        FocusedStyle-Border-BorderColor="#3399ff">
                                                                        <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                            <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                        </ValidationSettings>                                                            
                                                            ...
                                                            <tr id="tdFechaExp" runat="server">
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxLabel runat="server" ID="lblPlanta" Text="Planta" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td>
                                                                    <input type="hidden" id="hdnPlanta" runat="server" value='<%# Eval("codigoPlanta")%>' />
                                                                    <dx:ASPxComboBox class="form-control input-sm" ID="cmbPlanta" runat="server" IncrementalFilteringMode="Contains" 
                                                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" OnDataBound="cmbPlanta_DataBound"
