...
namespace ResiduosPeligrosos.dataAccess
{
    public class PlantaDa : Base
    {
        ...
        public int InsPlanta(int IdUser, string Codigo, string Descripcion, string Direccion, string Direccion2, string rfc)
        {
            Entity.Planta pnta = new Entity.Planta();
            pnta.Codigo = Codigo;
            pnta.Descripcion = Descripcion;
            pnta.Direccion = Direccion;
            pnta.direccion2 = Direccion2;
            pnta.rfc = rfc;
        ...
        public int UpdPlanta(int IdUser, int DeptoId, string Codigo, string Descripcion, string Direccion, string Direccion2, string rfc)
        {
            Entity.Planta pnta = new Entity.Planta();
