...
namespace ResiduosPeligrosos.dataAccess
{
    public class EmpleadosDa : Base
    {
        ...
        public int InsEmpleados(int UsuarioId, string Codigo, string NombreCompleto, string EMail, string Credencial, string NSS, string CodigoPlanta, string CodigoDepto, string CodigoPosicion, string CodigoProveedor, string CodigoAlmacen,string CodigoActivacion)
        {
            Entity.Empleados emp = new Entity.Empleados();
            emp.Codigo = Codigo;
            ...
            emp.CodigoAlmacen = CodigoAlmacen;
            emp.CodigoActivacion = CodigoActivacion;
        ...
        public int UpdEmpleados(int UsuarioId, int EmpleadoId, string Codigo, string NombreCompleto, string EMail, string Credencial, string NSS, string CodigoPlanta, string CodigoDepto, string CodigoPosicion, string CodigoProveedor,string CodigoAlmacen, string CodigoActivacion)
        {
            Entity.Empleados emp = new Entity.Empleados();
        ...
        public int DelDispositivoxCredencial(string Credencial)
        {
            Entity.DelDispositivoxCredencialResult_ regreso = JsonConvert.DeserializeObject<Entity.DelDispositivoxCredencialResult_>(methodPost("DelDispositivoxCredencial/" + Credencial.ToString()));
            return regreso.DelDispositivoxCredencialResult;
        }
    }
}