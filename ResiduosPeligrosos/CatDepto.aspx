<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatDepto.aspx.cs" Inherits="ResiduosPeligrosos.CatDepto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Departamentos \ Filtros">
                                    <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdDepartamento" runat="server" AutoGenerateColumns="False" 
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="DeptoId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="3" Caption="Descripción" Width="75%"></dx:GridViewDataTextColumn>
                    </Columns>
                                  ...
                                  <table style="width:100%; height:200px;">
                                     <tr style="background-repeat:repeat-x; background-image:url('Images/GreenBar.png'); vertical-align:middle">
                                        ...
                                        <td style="height:22px; text-align:right">
                                            <img src="Assets/Images/Close.png" alt="Cerrar" title="Cerar" style="cursor:pointer" onclick="return grid.CancelEdit();" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                            <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Registro de Departamentos" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                        </td>
                                    </tr>
                                    <tr>
