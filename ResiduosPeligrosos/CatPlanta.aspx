<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatPlanta.aspx.cs" Inherits="ResiduosPeligrosos.CatPlanta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Plantas\ Filtros">
                    <ContentTemplate>
                                                        ...
                                                        <tr>
                                                            <td style="width:100%">
                                                                ...
                                                                <td style="width:20%">
                                                                    <div class="div-container">
                                                                    <div class="div-img" >
                                                                    <img class="img" src="Assets/Images/trash_can.png" alt="Eliminar Seleccionados" style="cursor:pointer" onclick="return DisableSelected();" title=" Sleccionados" />
                                                                    </div>
                                                                    </div>
                                                            </td>
                                                            <td style="width:20%" >
    ...
    <div id="Detalle" runat="server">
        <dx:ASPxGridView ID="xgrdPlanta" runat="server" AutoGenerateColumns="False"  Width="100%" Font-Names="Segoe UI"
                    ...
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="PlantaId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1" Width="10px"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Código" Width="5%"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="3" Caption="Descripción" Width="35%"></dx:GridViewDataTextColumn>
                         <dx:GridViewDataTextColumn FieldName="Direccion" VisibleIndex="4" Caption="Dirección" Width="50%"></dx:GridViewDataTextColumn>
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Regisrtro de Plantas" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel1" Text="Dirección 1" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel4" Text="Dirección 2" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtDireccion2Edit" theme="SoftOrange" Width="200px" MaxLength="100" Text='<%# Eval("direccion2")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Campos requerido"/>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel5" Text="RFC" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
                                                        <dx:ASPxTextBox runat="server" ID="xtxtRFCEdit" theme="SoftOrange" Width="200px" MaxLength="100" Text='<%# Eval("rfc")%>' Font-Names="Segoe UI"
                                                            FocusedStyle-Border-BorderColor="#3399ff">
                                                            <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                <RequiredField IsRequired="true" ErrorText="Campos requerido"/>
