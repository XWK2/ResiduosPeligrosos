<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="wellcome.aspx.cs" Inherits="ResiduosPeligrosos.wellcome" %>
           ...
           <table style="width:100%; height:100%;">
                <tr style="align-content:center">
                    <td style="width:100%; height:100%;">
                        <table style="background-image:url('<%= ResolveClientUrl(ConfigurationManager.AppSettings["LoginCompleto"])%>');background-size:cover; width:100%">                         
