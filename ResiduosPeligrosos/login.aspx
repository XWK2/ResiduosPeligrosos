<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="ResiduosPeligrosos.login" %>
...
<html>
    ...
    <body style="background-image:url('<%= ResolveClientUrl(ConfigurationManager.AppSettings["LoginCompleto"])%>'); background-size:cover;">">
        <div>
                ...
                <form class="form-horizontal m-t-20" runat="server">
                    ...
                    <div class="form-group text-left"> 
                        <table style="width:100%;">
                            <tr>
                                <td>
                                    <dx:ASPxLabel Font-Bold="true" Font-Size="Medium" runat="server" ID="ASPxLabel6" Text="Usuario" width="100px" Font-Names="Segoe UI"></dx:ASPxLabel>
                                </td>
                                <td>
                                    ...
                                    <HelpTextSettings DisplayMode="Popup" HorizontalAlign="Center"></HelpTextSettings>
                                    <ValidationSettings SetFocusOnError="true" Display="Dynamic" CausesValidation="true">
                                        <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Camptura caracteres válidos" />
                            ...
                            <tr>
                                <td>
                                     <dx:ASPxLabel Font-Bold="true" Font-Size="Medium" runat="server" ID="ASPxLabel5" Text="Contraseña" width="100px" Font-Names="Segoe UI"></dx:ASPxLabel>
                                </td> 
                                <td>
                    ...
                    <div class="form-group text-center m-t-40">                 
                         ...
                         <asp:ImageButton ID="LoginImageButton" runat="server" AlternateText="Log In" CommandName="Login" CssClass="loginbutton" ImageUrl="Assets/Images/Entrar.png" OnClick="LoginImageButton_Click" />                                                    
                    </div>
                    <div>      
                    ...
                    <div class="form-group m-t-30">
                        <div class="col-sm-7 col-sm-offset-3">                            
                             <asp:LinkButton ID="hlkRecoveryPW" runat="server" Text="Recuperar Contraseña" OnClientClick="pcRecovery.Show(); return false;"></asp:LinkButton>
                        </div>
                    </div>
                    <div>
                         <dx:ASPxPopupControl ID="pcRecovery" runat="server" CloseAction="CloseButton" Modal="True" ShowHeader="False"
                            ...
                            HeaderText="Recuperar Contraseña" AllowDragging="True" PopupAnimationType="None" EnableViewState="False" Width="350px">
                            <ContentCollection>
                                                    ...
                                                    <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                        <tr style="height:40px">
                                                            <td style="text-align:left" colspan="2" >
                                                                <dx:ASPxLabel runat="server" ID="lblRecoveryTitle" Text="Recuperar Contraseña" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                            </td>
                                                        </tr>                                                       
                                                        <tr><td style="height:20px"></td></tr>
                                                        <tr style="align-content:center">  
                                                            <td style="text-align:left">
                                                                <dx:ASPxLabel runat="server" ID="ASPxLabel4" Text="Usuario" width="100px" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                            </td>                                                         
