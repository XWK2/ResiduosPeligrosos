<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatLocaciones.aspx.cs" Inherits="ResiduosPeligrosos.CatLocaciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Locaciones \ Filtros">
                        <ContentTemplate>
                                                                ...
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td style="width:20%">
                                                                            <div class="div-container">
                                                                                <div class="div-img" >
                                                                                    <img class="img" src="Assets/Images/trash_can.png" alt="Elimina Seleccionados" style="cursor:pointer" onclick="return DisableSelected();" title="Elimina Sleccionados" />
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                        <td style="width:20%" >
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdLocaciones" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="locacionId" 
                    oncustomcallback="xgrdLocaciones_CustomCallback" ClientInstanceName="grid" onrowdeleting="xgrdLocaciones_RowDeleting"                     
                    onrowvalidating="xgrdLocaciones_RowValidating" onrowinserting="xgrdLocaciones_RowInserting" onrowupdating="xgrdLocaciones_RowUpdating"
                    OnHtmlDataCellPrepared="xgrdLocaciones_HtmlDataCellPrepared" OnHtmlEditFormCreated="xgrdLocaciones_HtmlEditFormCreated" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="locacionId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Name="CheckID" VisibleIndex="1"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Código" Width="15%"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="nombreLocacion" VisibleIndex="3" Caption="Descripción"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="codigoAlmacen" VisibleIndex="4" Caption="Código de Almacén"></dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn FieldName="almacen" VisibleIndex="5" Caption="Almacén"></dx:GridViewDataTextColumn>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Registro de Locaciones" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="width:50%;">
                                                        <table style="width:100%; padding-left:0px; padding-right:0px; padding-bottom:0px; padding-top:0px">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxTextBox runat="server" ID="xtxtCodigoEdit" theme="SoftOrange" Width="200px" MaxLength="15" Text='<%# Eval("Codigo")%>' Font-Names="Segoe UI"
                                                    ...
                                                    <td style="width:50%;">
                                                        <table style="width:100%; padding-left:0px; padding-right:0px; padding-bottom:0px; padding-top:0px">
                                                            ...
                                                            <tr>
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxLabel runat="server" ID="lbllocacion" Text="Descripción" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td>
                                                                    <dx:ASPxTextBox runat="server" ID="xtxtNombreLocacionEdit" theme="SoftOrange" Width="200px" Text='<%# Eval("nombreLocacion")%>' Font-Names="Segoe UI"
                                                                        FocusedStyle-Border-BorderColor="#3399ff">
                                                                        <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                                                            <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Please enter just valid characters" />
                                                                        </ValidationSettings>                                                            
                                                            ...
                                                            <tr style="height:5px"></tr>
                                                            <tr id="tdFechaExp" runat="server">
                                                                <td style="padding-left: 10px;">
                                                                    <dx:ASPxLabel runat="server" ID="lblAlmacen" Text="Almacén" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                                </td>
                                                                <td>
                                                                    <input type="hidden" id="hdnAlmacen" runat="server" value='<%# Eval("codigoAlmacen")%>' />
                                                                    <dx:ASPxComboBox class="form-control input-sm" ID="cmbAlmacen" runat="server" IncrementalFilteringMode="Contains" 
                                                                        FilterMinLength="0" EnableCallbackMode="True" CallbackPageSize="20" OnDataBound="cmbAlmacen_DataBound"
