<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatProveedor.aspx.cs" Inherits="ResiduosPeligrosos.CatProveedor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
            Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Supplier\ Filtros">
                        <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
        <dx:ASPxGridView ID="xgrdProveedor" runat="server" ClientInstanceName="grid" Width="100%" AutoGenerateColumns="False" Font-Names="Segoe UI" Theme="Metropolis"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Nombre" VisibleIndex="3" Caption="Nombre" Width="25%">
                </dx:GridViewDataTextColumn>
                                        ...
                                        <td colspan="2">
                                            ...
                                            <div id="basic" class="tabcontent" style="display:flex">
                                                <table style="width:100%">
                                                    ...
                                                    <tr>
                                                        <td style="padding-left: 10px; padding-bottom:5px; padding-top:5px">
                                                            <dx:ASPxLabel runat="server" ID="lblCP" Text="Descripción" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <img class="img" src="Assets/Images/trash_can.png" alt="Eliminar Seleccionados" style="cursor:pointer" onclick="return DisableFabricantesSelected();"/>
                                                                    <img class="img" src="Assets/Images/delete_all.png" alt="Eliminar Seleccionados" style="cursor:pointer" onclick="return xgrdFabricantes.PerformCallback('Delete');"/>
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr> 
