<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatPosiciones.aspx.cs" Inherits="ResiduosPeligrosos.CatPosiciones" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="Busqueda" runat="server">
                    <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" 
                        Font-Bold="False">
                        <Groups>
                            <dx:NavBarGroup Text="Posiciones\ Filtros">
                                    <ContentTemplate>
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdPosicion" runat="server" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI" KeyFieldName="PosicionId" 
             ...
             OnHtmlDataCellPrepared="xgrdPosicion_HtmlDataCellPrepared" Theme="Metropolis">
                    <Columns>
                        <dx:GridViewDataTextColumn FieldName="PosicionId" Visible="false" Caption="Identifier" VisibleIndex="0"></dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataTextColumn FieldName="Descripcion" VisibleIndex="3" Caption="Descripción" Width="55%"></dx:GridViewDataTextColumn>
                         <dx:GridViewDataTextColumn FieldName="Nivel" VisibleIndex="4" Caption="Nivel" Width="20%"></dx:GridViewDataTextColumn>
                    </Columns>
                                            ...
                                            <table style="width:100%; padding-left:10px; padding-right:10px; padding-bottom:20px">
                                                <tr style="height:40px">
                                                    <td style="height:40px; padding-right:10px; text-align:right" colspan="2">
                                                        <dx:ASPxLabel runat="server" ID="ASPxLabel3" Text="Registro de Posiciones" Font-Size="13pt" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td style="padding-left: 10px">
                                                        <dx:ASPxLabel runat="server" ID="lblNivel" Text="Nivel" Font-Names="Segoe UI"></dx:ASPxLabel>
                                                    </td>
                                                    <td>
