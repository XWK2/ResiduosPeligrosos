<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="CatEmpleados.aspx.cs" Inherits="ResiduosPeligrosos.CatEmpleados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <script type="text/jscript">
        ...
        function OnCallbackBtnReset() {
            swal("Deleted", "Resete Mobile", "success");
        }
        ...
        function onSelectedAlmacenChanged(s, e) {
            ...
            cmbAlmacenEdit.PerformCallback(valor);
        }

        function onAlmacenEndCallback(s, e) {
            if (isResetRequired) {
                isResetRequired = false;
                cmbAlmacenEdit.SetEnabled(true);
            }
        }
    ...
    <div id="Busqueda" runat="server">
        <dx:ASPxNavBar ID="ASPxNavBar2" runat="server" Theme="Metropolis" Width="100%" Font-Bold="False">
            <Groups>
                <dx:NavBarGroup Text="Empleados \ Filtros">
                    <ContentTemplate>
                            ...
                            <table style="float: left; width: 40%" class="OptionsTable BottomMargin">
                                ...
                                <tr>
                                    <td style="width:10%; text-align:left">
                                        <dx:ASPxLabel ID="lblPosicion" runat="server" Text="Posición "/>
                                    </td>
                                ...
                                <tr>
                                    <td style="width:10%; text-align:left">
                                        <dx:ASPxLabel ID="lblName" runat="server" Text="Nombre ">
                                    </dx:ASPxLabel>
                                    </td>
                                    <td style="width:30%; text-align:left">
    ...
    <div id="Detalle" runat="server">
         <dx:ASPxGridView ID="xgrdEmpleado" runat="server" ClientInstanceName="grid" AutoGenerateColumns="False" Width="100%" Font-Names="Segoe UI"
            ...
            <Columns>
                ...
                <dx:GridViewDataTextColumn FieldName="Codigo" VisibleIndex="2" Caption="Código" Width="5%"/>                     
                <dx:GridViewDataTextColumn FieldName="NombreCompleto" VisibleIndex="3" Caption="Nombre" Width="15%"/>
                <dx:GridViewDataTextColumn FieldName="Email" VisibleIndex="4" Caption="Email" Width="10%"/>
                <dx:GridViewDataTextColumn FieldName="Credencial" VisibleIndex="5" Caption="Credencial" Width="5%"/>
                ...
                <dx:GridViewDataTextColumn FieldName="Planta" VisibleIndex="8" Caption="Planta" Width="10%"/>
                <dx:GridViewDataTextColumn FieldName="CodigoDepto" VisibleIndex="9" Caption="CodigoDepto" Width="5%" Visible="false"/>
                <dx:GridViewDataTextColumn FieldName="Departamento" VisibleIndex="10" Caption="Departamento" Width="10%"/>    
                <dx:GridViewDataTextColumn FieldName="CodigoPosicion" VisibleIndex="11" Caption="CodigoPosicion" Width="5%" Visible="false"/>
                <dx:GridViewDataTextColumn FieldName="Posicion" VisibleIndex="12" Caption="Posición" Width="10%"/>
                <dx:GridViewDataTextColumn FieldName="CodigoProveedor" VisibleIndex="13" Caption="CodigoProveedor" Width="5%" Visible="false"/>
                <dx:GridViewDataTextColumn FieldName="Proveedor" VisibleIndex="14" Caption="Proveedor" Width="10%"/>
                <dx:GridViewDataTextColumn FieldName="CodigoAlmacen" VisibleIndex="15" Caption="CodigoAlmacen" Width="5%" Visible="false"/>
                <dx:GridViewDataTextColumn FieldName="Almacen" VisibleIndex="16" Caption="Almacén" Width="10%"/>
                <dx:GridViewDataTextColumn FieldName="CodigoActivacion" VisibleIndex="17" Caption="CodigoActivacion" Width="5%" Visible="false"/>
            </Columns>
            <Styles>
                ...
                <EditForm>
                  <div class="container col-lg-12 col-md-11 col-sm-10 col-xs-5" style="background-color:#F2F2F2;padding:0px;margin:0px;">
                    <div class="form-group" style="width:100%;padding:0px;margin:0px;">
                        ...
                        <h4 class="modal-title" style="text-align:right;margin-top:10px;margin-bottom:10px;margin-right:5px;">Registro de Empleados</h4>
                        <h6 style="font-size:medium;align-content:center;background-color:#E0E0E0;height:24px;margin:1px 1px 5px 1px;padding-top:3px;">Descripción</h6>
                        <div class="col-md-6">
                            <div class="row">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblProveedor" Text="Proveedor" Font-Names="Segoe UI"/>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="ASPxLabel6" Text="Código" Font-Names="Segoe UI"/>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblDescription" Text="Nombre" Font-Names="Segoe UI"/>
                                <div class="col-md-9">
                        ...
                        <div class="col-md-6">            
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblPlanta" Text="Planta" Font-Names="Segoe UI"/>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="lblDepto" Text="Departmento" Font-Names="Segoe UI"/>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="ASPxLabel1" Text="Credencial" Font-Names="Segoe UI"/>
                                <div class="col-md-9">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <h6 style="font-size:medium;align-content:center;background-color:#E0E0E0;height:24px;margin:1px 1px 5px 1px;padding-top:3px;">Opciones usuarios de APP</h6>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row"> 
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="ASPxLabel2" Text="Almacén" Font-Names="Segoe UI"/> 
                                <div class="col-md-9">
                                    <input  type="hidden" id="hdncodigoAlmacen" value='<%# Eval("codigoAlmacen")%>' runat="server"/>
                                    <dx:ASPxComboBox  ID="cmbAlmacenEdit" ClientInstanceName="cmbAlmacenEdit" runat="server" CssClass="form-control input-sm Campos" FocusedStyle-Border-BorderColor="#3399ff" Font-Names="Segoe UI"  IncrementalFilteringMode="Contains" FilterMinLength="0" OnCallback="cmbAlmacenEdit_Callback" ClientEnabled="true"
                                        EnableCallbackMode="True" CallbackPageSize="20" Theme="SoftOrange" OnDataBound="cmbAlmacenEdit_DataBound" PopupVerticalAlign="Above" PopupHorizontalAlign="Center" ItemStyle-SelectedStyle-Font-Italic="true">
                                        <ValidationSettings>
                                            <RequiredField  IsRequired="true" ErrorText="Selecciona una opción"/>
                                        </ValidationSettings>                 
                        ...
                        <div class="col-md-6">
                            <div class="row">   
                                <dx:ASPxLabel CssClass="control-label col-md-3" runat="server" ID="ASPxLabel3" Text="Código de Activación" Font-Names="Segoe UI"/>
                                <div class="col-md-3">
                                <dx:ASPxTextBox CssClass="form-control input-sm Campos" runat="server" ID="xtxtCodigoActivacionEdit" theme="SoftOrange" MaxLength="30" Text='<%# Eval("CodigoActivacion")%>' Font-Names="Segoe UI" FocusedStyle-Border-BorderColor="#3399ff">
                                        <ValidationSettings SetFocusOnError="true" Display="Static" CausesValidation="true">
                                            <RegularExpression ValidationExpression="[A-Za-záéíóúñÑ,;:\.\/\_\-\s\d\(\)]+" ErrorText="Selecciona solo caracteres validos"/>
                                            <RequiredField IsRequired="true" ErrorText="Field Required"/>
                                        </ValidationSettings>                                                            
                        ...
                        <div class="col-md-12" >
                            <div class="row" style="border-top:15px; border-bottom:15px;">   
                                 <div class="col-md-offset-9 col-md-3" style="align-content:flex-end">
                                     <dx:ASPxButton ID="btnResetMobile" CssClass="" runat="server" Text="Reestablecer Móvil" Theme="SoftOrange" AutoPostBack="false" OnClick="btnResetMobile_Click">
                                            <ClientSideEvents Click="OnCallbackBtnReset"/>
                                     </dx:ASPxButton>  
                                 </div>
                            </div>
                            <br/>
